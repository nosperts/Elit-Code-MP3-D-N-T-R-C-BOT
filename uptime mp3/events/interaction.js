...
function dönüştürülüyor(user) {
  return new MessageEmbed()
    .setColor("RANDOM")
    .setDescription(`**Müzik Dönüştürülüyor. <a:2951loop:1207753475304202300>**`)
    .setFooter({
      text: `${user.tag}, tarafından kullanıldı.`,
      iconURL: user.displayAvatarURL({ dynamic: true }),
    });
...
function urlHata(user) {
  return new MessageEmbed()
    .setColor("ff0000")
    .setDescription(`**Müzik Süresi Fazla.**<:carpi:1206660519717634048>`)
    .setFooter({
      text: `${user.tag}, tarafından kullanıldı.`,
      iconURL: user.displayAvatarURL({ dynamic: true }),
    });
...
function müzikHata(user) {
  return new MessageEmbed()
    .setColor("ff0000")
    .setDescription(`**Müzik Dönüştürülemedi.**<:carpi:1206660519717634048>`)
    .setFooter({
      text: `${user.tag}, tarafından kullanıldı.`,
      iconURL: user.displayAvatarURL({ dynamic: true }),
    });
...
function müzikİndirildi(user, songInfo, message) {
  const audioEmbed = new MessageEmbed()
    ...
    .setDescription(`**Şarkı Dönüştürüldü.** <a:3551music:1207753717059821629> \n${songInfo.videoDetails.title}`)
